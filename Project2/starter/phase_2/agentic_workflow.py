...
from workflow_agents.base_agents import ActionPlanningAgent, KnowledgeAugmentedPromptAgent, EvaluationAgent, \
    RoutingAgent
import os
...
try:
    ...
    print("Erro: Arquivo 'Product-Spec-Email-Router.txt' não encontrado.")
    print("Certifique-se de que o arquivo está no mesmo diretório que agentic_workflow.py")
    exit()
...
def product_manager_support_function(query):
    """
    Support function for the Product Manager.
    Generates user stories and evaluates them.
    """
    print("   > Chamando Product Manager...")
...
def program_manager_support_function(query):
    """
    Support function for the Program Manager.
    Generates product features and evaluates them.
    """
    print("   > Chamando Program Manager...")
...
def development_engineer_support_function(query):
    """
    Support function for the Development Engineer.
    Generates development tasks and evaluates them.
    """
    print("   > Chamando Development Engineer...")
...
routes = [
    ...
    },
    {
        ...
        "description": "Responsible for defining development tasks to implement user stories.",
...
if not workflow_steps:
    print("Nenhum passo de workflow foi extraído. Encerrando.")
else:
    ...
    print("Final Output (last completed step):")
    if completed_steps:
        print(completed_steps[-1])
    else:
        print("Nenhum passo foi completado.")